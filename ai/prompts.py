...
class Prompts:
    ...
    STRATEGY_INSIGHT = (
        ...
        "    to close if the option has lost most of its value (e.g., 80% "
        "    profit), or consider adding a long call to cap the risk.\n\n"
        ...
        "ALGORITHMIC STRATEGIES (strategy_type: BollingerBands, or any other "
        "non-option, signal-driven strategy):\n"
