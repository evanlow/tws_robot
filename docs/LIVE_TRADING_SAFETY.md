...
- **Real-time risk monitoring** with RealTimeRiskMonitor tracking exposure, drawdown, daily loss, and position/exposure limits; correlation monitoring is available via the CorrelationAnalyzer component
