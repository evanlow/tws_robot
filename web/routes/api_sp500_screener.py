...
GET /api/stocks/sp500/screener
    Returns a compact screener payload listing all S&P 500 constituents
...
bp = Blueprint("api_sp500_screener", __name__, url_prefix="/api/stocks")
...
@bp.route("/sp500/screener", methods=["GET"])
def screener():
    """Return the S&P 500 screener payload.
    ...
    try:
        data = sp500_screener_service.get_screener_data(refresh=force_refresh)
    except Exception as exc:
        logger.error("S&P 500 screener scan failed: %s", exc, exc_info=True)
